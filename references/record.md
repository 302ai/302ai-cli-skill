...
```bash
302ai record get <request_ids> [--api_key <key>]
```
...
```bash
# Single request
302ai record get 568911aa-83d1-4054-9125-ddbbe413c2df

# Multiple requests
302ai record get id1,id2,id3
```
...
REQUEST_ID=$(302ai image fetch task_abc123 | jq -r '.request_id // .ai302_cost_request_ids')
